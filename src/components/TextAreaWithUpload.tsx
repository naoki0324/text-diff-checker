      ...
      <div className="flex justify-between items-center mb-2">
        ...
        >
          <input
            ...
            aria-label="タイトルを編集"
            className="text-sm md:text-base font-semibold text-slate-800 bg-transparent focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-white rounded-md p-1 -m-1 max-w-[120px]"
          />
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center px-3 py-1 bg-slate-100 text-slate-700 text-xs font-medium rounded-md hover:bg-slate-200"
          >
            <FileUploadIcon />
